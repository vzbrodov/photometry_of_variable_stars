...
# Снимки
Некоторые снимки пришлось убрать из рассмотрения. Например, в фильтре h снимок 16 поломан, а некоторые другие не подходят для метода апертуры. В апертуру попадают другие источники.
